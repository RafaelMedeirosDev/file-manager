...
import type {
  FolderNode,
  FileNode,
} from '../features/folders/hooks/useSidebar';
  ...
  return (
    <svg
      ...
      style={{
        ...
        height: 15,
        flexShrink: 0,
        color: active ? '#0078D4' : 'rgba(255,200,80,0.75)',
      }}
    >
  ...
  return (
    <svg
      ...
      style={{
        ...
        height: 15,
        flexShrink: 0,
        color: active ? '#0078D4' : 'rgba(255,255,255,0.4)',
      }}
    >
      ...
      >
        ...
        {isAdmin && (
          <div className="sb-mobile-nav">
            ...
            <button
              type="button"
              className={`sb-item${isUsersPage ? ' active' : ''}`}
            ...
            <button
              type="button"
              className={`sb-item${isExamsPage ? ' active' : ''}`}
            ...
            <button
              type="button"
              className={`sb-item${location.pathname === '/exams' ? ' active' : ''}`}
