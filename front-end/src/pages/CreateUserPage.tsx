...
function Step1Identity({
  ...
  return (
    <div
      className={
        direction === 'forward' ? 'wiz-enter-forward' : 'wiz-enter-back'
      }
    >
            ...
            {showPasswordHint && (
              <p
                style={{
                  ...
                  fontSize: 12,
                  fontFamily: 'Manrope, sans-serif',
                  color: passwordsMatch ? '#10b981' : '#e11d48',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 4,
                }}
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Configure identidade, pastas e confirme o cadastro.
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="page-content">
        ...
        {wizard.step === 2 && (
          <Step2Folders
            ...
            folderInput={wizard.folderInput}
            setFolderInput={wizard.setFolderInput}
