...
export function FoldersBulkCreatePage() {
  ...
  const allSelected =
    ...
    usersOptions.every((u) => selectedUserIds.has(u.id));
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Crie múltiplas pastas para vários usuários de uma vez.
          </p>
        </div>
        <button
          type="button"
        ...
        {step === 1 && (
          <div className="wiz-enter-forward">
            <div style={{ maxWidth: 480, margin: '0 auto' }}>
              ...
              >
                Adicione os nomes das pastas que serão criadas para cada usuário
                selecionado.
              </p>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                  {usersOptions.map((u) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`users-avatar ${avatarClass(u.name)}`}
            ...
            <div style={{ maxWidth: 560, margin: '0 auto' }}>
              ...
              >
                ...
                {combinations.map((c, i) => {
                  const result = creationResults.find(
                    (r) =>
                      r.folderName === c.folderName && r.userId === c.userId,
                  );
                    ...
                    >
                      <span
                        style={{
                          fontFamily: 'Manrope, sans-serif',
                          fontSize: 13,
                          color: c.conflict ? '#be123c' : '#0d1e35',
                          fontWeight: 500,
                        }}
                      >
                        📁 {c.folderName}
                      ...
                      <span
                        style={{
                          fontFamily: 'Manrope, sans-serif',
                          fontSize: 13,
                          color: c.conflict ? '#be123c' : '#334155',
                        }}
                      >
                        {userName}
                      </span>
              ...
              {hasResults && (
                ...
                >
                  <span style={{ color: '#10b981', fontWeight: 600 }}>
                    {
                      creationResults.filter((r) => r.status === 'fulfilled')
                        .length
                    }{' '}
                    criadas com sucesso
                  </span>
                  {creationResults.filter((r) => r.status === 'rejected')
                    .length > 0 && (
                    <>
                      {' '}
                      ·{' '}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                {!hasResults ? (
                  ...
                  >
                    {confirming
                      ? 'Criando...'
                      : `Confirmar (${validCombinations.length})`}
                  </button>
                ) : (
                  <button
                    type="button"
