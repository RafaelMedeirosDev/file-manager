...
export function FoldersPage() {
  ...
  const selectedUser =
    usersOptions.find((u) => u.id === selectedUserId) ?? null;
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Navegue e organize a estrutura de diretórios.
          </p>
        </div>
        {isAdmin ? (
            ...
            {comboOpen && (
              <div
                style={{
                  ...
                  borderRadius: 12,
                  boxShadow:
                    '0 8px 24px rgba(13,30,53,0.12), 0 2px 6px rgba(13,30,53,0.06)',
                  overflow: 'hidden',
                  maxHeight: 280,
                  overflowY: 'auto',
                }}
            ...
            {loading ? (
              ...
              <>
                ...
                >
                  {visibleFolders.map((folder) => {
                    const ownerName =
                      usersById.get(folder.userId) ?? 'Usuário desconhecido';
                    return (
                      <li key={folder.id}>
                        <Link
